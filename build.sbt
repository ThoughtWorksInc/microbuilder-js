...
haxelibDependencies += "microbuilder-core" -> DependencyVersion.SpecificVersion("3.0.4")

libraryDependencies += "com.thoughtworks.microbuilder" % "microbuilder-core" % "3.0.4" % HaxeJs classifier HaxeJs.name

libraryDependencies += "com.thoughtworks.microbuilder" % "json-stream-core" % "3.0.3" % HaxeJs classifier HaxeJs.name
