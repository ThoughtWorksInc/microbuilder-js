...
haxelibDependencies += "microbuilder-core" -> DependencyVersion.SpecificVersion("1.0.0")

libraryDependencies += "com.thoughtworks.microbuilder" % "microbuilder-core" % "1.0.0" % HaxeJs classifier HaxeJs.name
